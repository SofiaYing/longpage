(function(window, undefined) {
    ...
    window.onload = function() {
        Pace.on('hide', function() {
            document.getElementsByClassName('loadingBox')[0].style.display = 'none'
        });
    ...
    // var percent = document.getElementsByClassName('pace-progress')[0].dataset.progress;
    ...
    // var process = document.getElementsByClassName('pace-progress')[0].dataset.progress;
    loading();
