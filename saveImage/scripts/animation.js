...
//            }
    ...
    function Animation(demo, data, type, effect, direction, playDelay, playTime) {
        //进入时渐隐
    	if (type.search("fromAppearance") !== -1 && effect.indexOf("fade") >= 0) {
            demo.css({ 'display': 'block', 'opacity': 1 });
        }
        if (playDelay > 0)
        {
            setTimeout(function () {
                if ((type.search("toAppearance") !== -1 && effect == "fallOut" && direction == "bottom") ||
                        (type.search("toAppearance") !== -1 && effect == "flyOut" && direction == "bottom") ||
                        (type.search("toAppearance") !== -1 && effect.indexOf("fade") >= 0 && direction == "bottom"))
                {
                ...
                switch (effect)
                {
                    ...
                    case "mySlideInRight":
                    case "slideInLeftTop":
                    case "slideInRightTop":
                    case "slideInLeftBottom":
                    case "slideInRightBottom":
                    case "mySlideOutUp":
                    case "mySlideOutDown":
                    case "mySlideOutLeft":
                    case "mySlideOutRight":
                    case "slideOutLeftTop":
                    case "slideOutRightTop":
                    case "slideOutLeftBottom":
                    case "slideOutRightBottom":
                    ...
                    case "backInLeftTop":
                    case "backInRightTop":
                    case "backInLeftBottom":
                    case "backInRightBottom":
                    case "backOutUp":
                    case "backOutDown":
                    case "backOutLeft":
                    case "backOutRight":
                    case "backOutLeftTop":
                    case "backOutRightTop":
                    case "backOutLeftBottom":
                    case "backOutRightBottom":
